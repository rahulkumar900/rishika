      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden border-b border-slate-900">
        ...
        <div className="container px-4 md:px-6 mx-auto relative z-20 max-w-6xl">
          ...
          <div className="flex flex-wrap items-center gap-3 mb-6">
            <div className="bg-primary text-primary-foreground font-black uppercase tracking-widest text-xs px-4 py-2">
              {project.category}
            </div>
            {(project as { status?: string }).status === "Running" && (
              <div className="flex items-center gap-2 bg-emerald-500/15 border border-emerald-500/40 text-emerald-400 font-black uppercase tracking-widest text-xs px-4 py-2">
